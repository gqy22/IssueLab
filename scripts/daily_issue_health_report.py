#!/usr/bin/env python3
"""Generate a daily Issue/Actions health report and save as Markdown.

Usage:
  python scripts/daily_issue_health_report.py --repo owner/repo --hours 24 --output /tmp/report.md
"""
